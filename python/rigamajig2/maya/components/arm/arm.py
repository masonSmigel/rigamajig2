...
# RIGAMAJIG
import rigamajig2.maya.components.limb.limb
import rigamajig2.maya.rig.control as rig_control
import rigamajig2.maya.transform as rig_transform


class Arm(rigamajig2.maya.components.limb.limb.Limb):
    """
    ...
    def __init__(self, name, input, size=1, rigParent=str(), componentTag=None):
        ...
        # self.limb_autoWristName = self.name.split("_")[0] + "_autoWrist"

        # self.defineParameter(parameter="limb_autoWristName", value=self.limb_autoWristName,dataType="string")
    ...
    def _rigSetup(self):
        ...
        multMatrix, pickMatrix = rig_transform.connectOffsetParentMatrix(
