...
class Main(rigamajig2.maya.components.base.Base):
    """
    ...
    def _rigSetup(self):
        ...
        rigamajig2.maya.node.multMatrix(
        ...
        overrideModelAttr = rigamajig2.maya.attr.createEnum(
            self.trsShot.name,
            longName="modDisplay",
