...
class DataLoader(QtWidgets.QWidget):
    ...
    def createActions(self):
        ...
        self.loadSelectedDataAction.setIcon(Resources.getIcon(":icons/general/file"))
        ...
        self.saveSelectedAction.setIcon(Resources.getIcon(":icons/general/save"))
    ...
    def createWidgets(self):
        ...
        self.addPathButtton.setIcon(Resources.getIcon(":icons/general/plus"))
        ...
        self.expandWidgetButton.setIcon(Resources.getIcon(":icons/general/caret-down"))
        ...
        self.contractWidgetButton.setIcon(Resources.getIcon(":icons/general/caret-up"))
    ...
    def __getAddEmptyDatatypeActions(self):
        ...
        for dataType in self.DATA_TYPE_LIST:
            ...
            action.setIcon(Resources.getIcon(":icons/general/file"))
    ...
    def addItem(self, path=None):
        ...
        # icon
        item.setIcon(0, Resources.getIcon(":icons/general/file"))
